...
export class PesquisaImoveisResidenciaisController implements Controller {

  constructor(private readonly pesquisaImoveis: PesquisaImoveisResidenciais) {
  ...
  async handle(httpRequest: HttpRequest): Promise<HttpResponse> {
    ...
    const resultado = await this.pesquisaImoveis.pesquisarImoveisResidenciais({ query: httpRequest?.query })
