...
export class ImoveisResidenciaisRepositorioStub implements PesquisaImoveisResidenciais {

  async pesquisarImoveisResidenciais(params: any): Promise<ImovelResidencial[]> {

    const imoveis: Array<ImovelResidencial> = []
    return imoveis

  }
}

const targetFactory = (): PesquisaImoveisResidenciaisController => {

  const target = new PesquisaImoveisResidenciaisController(imoveisResidenciaisRepositorioStub)
...
describe('PesquisaImoveisResidenciaisController', () => {
  ...
  test('Deve passar os parâmetros corretos para ImoveisResidenciaisRepositorio ', async () => {
    ...
    const spyPesquisarImoveisResidenciais = jest.spyOn(imoveisResidenciaisRepositorioStub, 'pesquisarImoveisResidenciais');
